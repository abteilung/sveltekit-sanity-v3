...
<script lang="ts">
  ...
  import QuantityWidget from '$lib/Components/Shop/QuantityWidget.svelte'
  ...
  <div class="body">
    ...
    <div class="options">
      ...
      <div class="options-qty-atc">
        ...
        <button type="submit" on:click|preventDefault={addToCart} class="add-to-cart {addedToCart ? 'animate' : ''}">
          {#if !addedToCart}
            <p>Add To Cart</p>
            <img class="" src="/shopping-cart.svg" alt="" width="25" height="25" loading="lazy" decoding="async" />
        ...
        <button class="buy-now" on:click={quickBuy}>
          <p>Buy Now</p>
          <img class="" src="/hand-shake.svg" alt="" width="25" height="25" loading="lazy" decoding="async" />
        </button>
      </div>
    </div>
  </div>
